...
public class Robot extends LoggedRobot {
    ...
    public Robot() {
        ...
        Logger.recordMetadata("Drive", Constants.tankDriveEnabled ? "true" : "false");
        Logger.recordMetadata("Turret", Constants.turretEnabled ? "true" : "false");
        Logger.recordMetadata("Shooter", Constants.shooterEnabled ? "true" : "false");
        Logger.recordMetadata("PitchAdjuster", Constants.pitchAdjusterEnabled ? "true" : "false");
        Logger.recordMetadata("Pneumatics", Constants.pneumaticsEnabled ? "true" : "false");
        Logger.recordMetadata("LEDs", Constants.ledsEnabled ? "true" : "false");
